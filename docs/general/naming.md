...
- It is not recommended to use an existing OpenTelemetry semantic convention
  namespace as a prefix for new custom attribute name specific to your company or
  application. Doing so may result in a name clash in the future, if OpenTelemetry
